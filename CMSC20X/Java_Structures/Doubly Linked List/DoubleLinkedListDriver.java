/**
 GUI for testing a Basic Doubly Linked List and a Sorted Doubly Linked List
 * with an external iterator
 * Allows testing for add: add, add to front, add to end
 * retrieve: retrieve first, retrieve last
